...
public class OldDgParser extends StackDataSheetsParser implements VesselProfileDataAdder {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OldDgParser.class);
     ...
     * @param data40
     */
    public OldDgParser(final StowbaseObjectFactory stowbaseObjectFactory, final Messages messages,
